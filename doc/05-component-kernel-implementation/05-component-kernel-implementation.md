...
I will model this data structure using a sequence because it is ordered and you can access each point in it like a playlist where you can access each song and move them around.
